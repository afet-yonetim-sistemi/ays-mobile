# Contributing to Afet Yönetim Sistemi (AYS) Mobile App
...
1. Check if the issue has already been reported by searching the [issue tracker](https://github.com/afet-yonetim-sistemi/ays-mobile/issues).

2. If it hasn't been reported, [open a new issue](https://github.com/afet-yonetim-sistemi/ays-mobile/issues/new) and provide detailed information about the bug, including how to reproduce it and what you expected to happen.

### Suggesting Enhancements

We welcome suggestions for new features or enhancements. To suggest an enhancement:

1. Check the [issue tracker](https://github.com/afet-yonetim-sistemi/ays-mobile/issues) to see if the enhancement has already been proposed.

2. If not, [open a new issue](https://github.com/afet-yonetim-sistemi/ays-mobile/issues/new) and describe your proposed enhancement in detail, including its use case and benefits.
...
Join our community discussions and help others on the project's [GitHub Discussions](https://github.com/afet-yonetim-sistemi/ays-mobile/discussions) page. Engaging with the community is a great way to learn, share knowledge, and collaborate with other contributors and users of the project.
